...
A banner is a message or notification displayed to users when they connect to a remote system, network device, or application. Banners provide information, warnings, or legal notices before login or access is granted, setting expectations and establishing terms of use.
